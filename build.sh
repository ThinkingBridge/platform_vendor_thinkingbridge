...
echo -e "${cya}Building ${bldcya}ThinkingBridge for $DEVICE ${txtrst}";
...
if [ -n "${INTERACTIVE}" ]; then
        ...
        if [ "${VENDOR}" == "thinkingbridge" ]; then
                echo -e "[${bldgrn}lunch thinkingbridge_$DEVICE-userdebug${bldblu}]${txtrst}"
        else
